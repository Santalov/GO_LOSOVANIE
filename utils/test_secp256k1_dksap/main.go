...
func main() {
	...
	compressedPkey := crypto.CompressPubkey(&ephemeralDestinationPkey)
	fmt.Println("compressed pkey", compressedPkey)
	fmt.Println("compressed pkey length", len(compressedPkey))
